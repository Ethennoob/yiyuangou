...
class PHPExcel
{
	...
	* 所有宏代码 (vbaProject.bin 文件，这包括窗体、 代码等。
	*
	* @var binary
	*/
	...
	* 如果已签署宏，，包含 vbaProjectSignature.bin 文件，NULL 如果不签署
	*
	* @var binary
	*/
	...
	* 如果工作簿不是 Excel 2007，则为空或不包含自定义的 UI
	*
	* @var NULL|string
	*/
	...
	*/
     ...
     *    
     *    断开所有工作表从这个 PHPExcel 工作簿对象，
     *    通常这样的 PHPExcel 对象可以是未设置
     *
     */
